...
public class CompanyServiceTests
{
    ...
    public async Task CompanyService_ValidateCompanyData()
    {
        ...
        var url = config.BaseUrl + "/company/validate";
        ...
        var result = await service.ValidateCompanyData(true, new() { Request = null }, "2.0");
    ...
    public async Task CompanyService_CompanySearch()
    {
        ...
        var url = config.BaseUrl + "/company/search";
        ...
        var result = await service.CompanySearch(true, new() { Request = null }, "2.0");
    ...
    public async Task CompanyService_GetCompanyData()
    {
        ...
        var url = config.BaseUrl + "/company/get";
        ...
        var result = await service.GetCompanyData(true, new() { Request = null }, "2.0");
